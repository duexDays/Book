<div class="form-popup" id="myBookForm">
    <form action="bookSave.php" class="form-container" method="POST">
        ...
        <section class="save-contents">
            <section class="option-button-container">
                ...
                <input type="hidden" id="wantType" name="wantType" value="1">
            </section>
            <section class="selected-display">
                ...
                <div class="option-container"><textarea id="review" name="review" rows="5" cols="40"></textarea></div>
